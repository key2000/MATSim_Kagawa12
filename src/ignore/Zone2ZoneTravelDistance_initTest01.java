 ...
 * @author dziemke
 */
public class Zone2ZoneTravelDistance_initTest01 implements IterationEndsListener {
    private final static Logger log = Logger.getLogger(Zone2ZoneTravelDistance_initTest01.class);
    ...
    public Zone2ZoneTravelDistance_initTest01(Controler controler, Network network,
